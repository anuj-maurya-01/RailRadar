...
- **Backend**: Hosted on [Render](https://render.com) using [`render.yaml`](render.yaml) or a manual Python Web Service.
- **Frontend**: Hosted on [Vercel](https://vercel.com) using [`frontend/vercel.json`](frontend/vercel.json) with Vite preset.
