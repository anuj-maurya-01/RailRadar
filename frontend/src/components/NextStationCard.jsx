...
export const NextStationCard = ({ prediction }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs p-5 sm:p-6 flex flex-col justify-between">
      <div>
        {/* Card Header */}
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 flex-wrap gap-2">
          <div className="flex items-center space-x-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span className="text-xs text-slate-400 dark:text-slate-500 block truncate">Timetable &amp; Dynamic Arrival</span>
            </div>
          </div>
          {stationCode !== 'Not available' && (
            <span className="px-2.5 py-0.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 text-xs font-mono font-bold border border-slate-200 dark:border-slate-700 shrink-0">
              {stationCode}
            </span>
          )}
        </div>
        ...
        <div className="mt-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Upcoming scheduled station checkpoint</p>
        </div>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/60 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-700">
          <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 font-semibold pb-2 border-b border-slate-200/60 dark:border-slate-700">
            ...
            <span className="text-[11px] text-slate-400 dark:text-slate-500 font-normal">Timetable vs Expected</span>
          </div>

          <div className="mt-2.5 grid grid-cols-2 gap-3 text-sm">
            <div>
              <div className="text-[11px] font-medium text-slate-500 dark:text-slate-400">Scheduled Arrival</div>
              <div className="font-mono font-bold text-slate-800 dark:text-slate-200 text-base mt-0.5">
                {scheduledArrival}
              </div>
            </div>
            <div>
              <div className="text-[11px] font-bold text-blue-600 dark:text-blue-400">Expected Arrival</div>
              <div className="font-mono font-extrabold text-blue-700 dark:text-blue-300 text-base mt-0.5">
                {expectedArrival}
              </div>
            </div>
          </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-800/60 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-700">
          ...
          <div className="mt-2.5 grid grid-cols-2 gap-3 text-sm">
            <div>
              <div className="text-[11px] font-medium text-slate-500 dark:text-slate-400">Scheduled Departure</div>
              <div className="font-mono font-bold text-slate-800 dark:text-slate-200 text-base mt-0.5">
                {scheduledDeparture}
              </div>
            </div>
            <div>
              <div className="text-[11px] font-bold text-blue-600 dark:text-blue-400">Expected Departure</div>
              <div className="font-mono font-extrabold text-blue-700 dark:text-blue-300 text-base mt-0.5">
                {expectedDeparture}
              </div>
            </div>
