    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="px-5 sm:px-6 py-4 border-b border-slate-200 flex flex-wrap items-center justify-between gap-3 bg-slate-50">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs font-medium">
          <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded bg-slate-100 text-slate-700 border border-slate-200">
            <span className="w-2 h-2 rounded-full bg-slate-500"></span>
            <span>Scheduled Baseline</span>
          </div>
          <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded bg-indigo-50 text-indigo-700 border border-indigo-200 font-semibold">
      ...
      <div className="p-5 sm:p-6 lg:p-7 space-y-6">
        ...
        <div className="bg-slate-50/80 rounded-xl p-4 sm:p-5 border border-slate-200/80">
          <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-slate-200/60">
            <div>
              ...
              <div className="flex items-baseline space-x-2 mt-0.5">
                ...
                {nextStationCode !== 'Not available' && (
                  <span className="px-1.5 py-0.2 rounded bg-slate-200 text-slate-700 text-xs font-mono font-bold">
                    {nextStationCode}
                  </span>
                )}
              </div>
            ...
            {hasPredDelay && (
              <div className="inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-lg bg-indigo-100 text-indigo-800 text-xs font-mono font-bold">
          ...
          <div className="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-xs">
              <div className="flex items-center justify-between text-xs font-semibold text-slate-500 pb-2">
                ...
                <span className="text-[11px] font-mono text-slate-400">Timetable &rarr; ML Expected</span>
              </div>

              {/* Time Nodes */}
              <div className="mt-3 flex items-center justify-between font-mono gap-2">
                <div className="shrink-0">
                  <div className="text-[10px] font-sans font-semibold text-slate-400 uppercase">
                    Scheduled
                  </div>
                  <div className="text-sm sm:text-base md:text-lg font-bold text-slate-800 mt-0.5">
                    {schedArr}
                  </div>
                </div>

                <div className="flex-1 min-w-0 mx-1 sm:mx-3 flex flex-col items-center">
                  <div className="text-[10px] sm:text-[11px] font-sans font-bold text-amber-600 truncate max-w-full">
                  ...
                  <div className="w-full relative flex items-center my-1">
                    ...
                    <ArrowRight className="w-3.5 h-3.5 text-indigo-600 shrink-0 -ml-1" />
                  </div>
                  <div className="text-[9px] sm:text-[10px] font-sans text-slate-400 truncate max-w-full">
                    ML delay extension
                  </div>
                </div>

                <div className="shrink-0 text-right">
                  <div className="text-[10px] font-sans font-bold text-indigo-600 uppercase">
                    ML Expected
                  </div>
                  <div className="text-sm sm:text-base md:text-lg font-extrabold text-indigo-700 mt-0.5">
                    {expArr}
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-100">
            ...
            {hasLiveDelay && hasPredDelay && (
              <div className="flex items-center space-x-1.5 text-xs font-semibold px-2.5 py-1 rounded-full bg-slate-50 border border-slate-200">
                {delayTrend === 'recovering' && (
                  <>
          ...
          <div className="mt-5 space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-bold text-indigo-700 uppercase tracking-wider flex items-center space-x-1">
                  <span>ML PREDICTED DELAY (AI Model)</span>
                  <span className="text-[10px] px-1.5 py-0.2 rounded bg-indigo-100 text-indigo-800 font-normal">
        ...
        <div className="bg-gradient-to-r from-slate-50 via-emerald-50/30 to-blue-50/20 p-4 sm:p-5 rounded-xl border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1 min-w-0">
            ...
            <div className="text-base sm:text-lg font-extrabold text-slate-900 break-words">
              {destName}
            </div>
            <p className="text-xs text-slate-500">
          ...
          <div className="flex flex-wrap items-center gap-3 font-mono">
            {destSchedArr !== 'Not available' && (
              <div className="px-3.5 py-2 rounded-lg bg-white border border-slate-200 text-center flex-1 sm:flex-initial">
                <div className="text-[10px] font-sans font-semibold text-slate-400 uppercase">
                  Scheduled Terminus
                </div>
