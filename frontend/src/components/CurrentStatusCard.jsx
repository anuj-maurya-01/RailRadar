    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs p-5 sm:p-6 flex flex-col justify-between">
      <div>
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 flex-wrap gap-2">
          <div className="flex items-center space-x-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span className="text-xs text-slate-400 dark:text-slate-500 block truncate">Live GPS telemetry</span>
            </div>
          </div>

          <div className="flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border border-emerald-500/20 shrink-0">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Most recent railway checkpoint reported</p>
        </div>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="bg-slate-50 dark:bg-slate-800/60 p-3 rounded-xl border border-slate-200/80 dark:border-slate-700">
          <div className="flex items-center space-x-1 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">
            <Clock className="w-3.5 h-3.5 text-slate-400" />
            <span>Delay</span>
          </div>
          <div
            className={`text-lg font-black font-mono ${
              isDelayed ? 'text-amber-600 dark:text-amber-400' : isOnTime ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-900 dark:text-white'
            }`}
          >
            {formattedDelay}
          </div>
